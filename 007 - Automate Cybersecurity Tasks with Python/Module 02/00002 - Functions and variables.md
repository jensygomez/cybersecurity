...
In Python, an **argument** is the data brought into a function when it is called. When calling r**emaining_login_attempts** in the following example, the integers **3** and **2** are considered arguments:
